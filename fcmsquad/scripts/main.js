...
const notices = "2024.11.17 미페 추가<br><b>- [EURO24] 알렉스 레미로, 오야르사발<br>- [COPA24] J. 아람부루<br>- [TOTS24] Y. 비세크, 구보 타케후사<br>- [CT24] R. 르 노르망<br>- [HERO24] 수벨디아<br>- [ALL] 아드난 야누자이<br>- [TOTY22] NYI<br>- [TOTY22][HM] 크리스티아누 호날두, 루카 모드리치, 토마스 뮐러, E. 홀란, 모하메드 살라, A. 뤼디거, E. 멘디, 다비드 알라바</b>";
const nickData = [
    {nick: "팽이", name: "안토니"},
