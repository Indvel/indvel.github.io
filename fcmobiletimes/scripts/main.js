const datas = [
    ...
    {name: "UCL22 그룹스테이지", otherNames: ["챔스22", "22챔스", "챔스", "그룹"], image: "./resources/cards/UCL22_GS.png", eo: 1, min: 20, sec: 0},
    {name: "UCL22 16강", otherNames: ["챔스22", "22챔스", "챔스"], image: "./resources/cards/UCL22_16.png", eo: 1, min: 28, sec: 0},
    {name: "UCL22 8강", otherNames: ["챔스22", "22챔스", "챔스"], image: "./resources/cards/UCL22_8.png", eo: 1, min: 29, sec: 0},
    {name: "UCL22 4강", otherNames: ["챔스22", "22챔스", "챔스"], image: "./resources/cards/UCL22_4.png", eo: 1, min: 32, sec: 0},
    ...
    {name: "COPA24_LIVE", otherNames: ["코파", "코파24", "24코파", "COPA", "아르헨티나","현역"], image: "./resources/cards/COPA24_Live_ARGENTINA.png", eo: 0, min: 45, sec: 10},
    {name: "COPA24_ICON/HERO", otherNames: ["코파", "코파24", "24코파", "COPA", "아르헨티나", "아이콘", "히어로"], image: "./resources/cards/COPA24_ICON_ARGENTINA.png", eo: 1, min: 9, sec: 0},
    ...
    {name: "BLD24_LIVE", otherNames: ["발롱도르", "발롱", "BLD", "BD", "현역"], image: "./resources/cards/BLD24_LIVE.png", eo: 0, min: 51, sec: 35},
    {name: "BLD24_ICON", otherNames: ["발롱도르", "발롱", "BLD", "BD", "아이콘"], image: "./resources/cards/BLD24_ICON.png", eo: 1, min: 11, sec: 15},
    {name: "DY24_LIVE", otherNames: ["DY", "DYNASTIE", "다이너스티", "디와이", "부자", "형제", "사촌", "현역"], image: "./resources/cards/DY24_LIVE.png", eo: 0, min: 53, sec: 30}
];
