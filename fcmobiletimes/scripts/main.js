const datas = [
    ...
    {name: "UCL22 Best", otherNames: ["22챔베", "챔베22", "챔베"], image: "./resources/cards/UCL22_Best.png", eo: 1, min: 33, sec: 0},
    {name: "TOTS22", otherNames: ["토츠22", "22토츠", "토츠"], image: "./resources/cards/TOTS22.png", eo: 1, min: 33, sec: 30},
    {name: "UTOTS22", otherNames: ["얼토츠22", "22얼토츠", "얼토츠"], image: "./resources/cards/TOTS22_UT.png", eo: 1, min: 35, sec: 50},
    ...
    {name: "월드컵22 스타", otherNames: ["월드컵", "월스"], image: "./resources/cards/WorldCup22_Star.png", eo: 0, min: 13, sec: 30},
    {name: "월드컵22 베스트", otherNames: ["월드컵", "월베"], image: "./resources/cards/WorldCup22_Best.png", eo: 0, min: 13, sec: 15},
    {name: "월드컵22 헤드라인", otherNames: ["월드컵", "월헤", "중국방석", "헤드라인"], image: "./resources/cards/WorldCup22_Headlines.png", eo: 0, min: 12, sec: 14},
    {name: "월드컵 아이콘", otherNames: ["월드컵", "월콘", "월드콘"], image: "./resources/cards/WCIcon.png", eo: 1, min: 6, sec: 0},
    {name: "IF23", otherNames: ["IF23", "이프"], image: "./resources/cards/IF23.png", eo: 1, min: 21, sec: 0},
    ...
    {name: "UTOTS23", otherNames: ["얼토츠23", "23얼토츠", "얼토츠"], image: "./resources/cards/TOTS23_UT.png", eo: 0, min: 37, sec: 5},
    {name: "UCL23", otherNames: ["챔스23", "23챔스"], image: "./resources/cards/UCL23_TOP25.png", eo: 0, min: 27, sec: 0},
    {name: "UCL23 Best", otherNames: ["23챔베", "챔베22", "챔베"], image: "./resources/cards/UCL23_Best.png", eo: 0, min: 37, sec: 5},
    ...
    {name: "Founders24 아이콘", otherNames: ["파운더스234", "파운더스", "1차", "아이콘"], image: "./resources/cards/Founders24_Icon.png", eo: 1, min: 8, sec: 0},
    {name: "Founders24 아이콘(H)", otherNames: ["파운더스234", "파운더스", "1차", "아이콘"], image: "./resources/cards/Founders24_Icon.png", eo: 0, min: 1, sec: 0},
    ...
    {name: "UCL24 베이스", otherNames: ["챔스24", "24챔스", "베이스"], image: "./resources/cards/UCL24_Base.avif", eo: 0, min: 54, sec: 50},
    {name: "UCL24 스타", otherNames: ["챔스24", "24챔스", "스타"], image: "./resources/cards/UCL24_Star.avif", eo: 1, min: 11, sec: 0},
